...
class CustomTabsInternalSettingsActivity : DuckDuckGoActivity() {
    ...
    private fun registerActivityResultLauncher() {
        defaultAppActivityResultLauncher =
    ...
    private fun configureListeners() {
        binding.load.setOnClickListener {
            ...
            if (url.isNotBlank()) {
                ...
                Toast.makeText(this, getString(R.string.customTabsEmptyUrl), Toast.LENGTH_SHORT)
                    .show()
            }
        }
    ...
    private fun openCustomTab(url: String) {
        ...
        kotlin.runCatching {
            ...
            Toast.makeText(this, getString(R.string.customTabsInvalidUrl), Toast.LENGTH_SHORT)
                .show()
        }
    }
