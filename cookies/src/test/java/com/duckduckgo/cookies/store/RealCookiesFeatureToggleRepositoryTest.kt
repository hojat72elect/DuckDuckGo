...
class RealCookiesFeatureToggleRepositoryTest {
    lateinit var testee: com.duckduckgo.cookies.store.RealCookiesFeatureToggleRepository

    private val mockCookiesFeatureToggleStore: com.duckduckgo.cookies.store.CookiesFeatureToggleStore = mock()

    @Before
    fun before() {
        testee = com.duckduckgo.cookies.store.RealCookiesFeatureToggleRepository(
    ...
    fun whenInsertThenInsertCalled() {
        val cookieFeatureToggle =
            com.duckduckgo.cookies.store.CookiesFeatureToggles(Cookie, true, null)
