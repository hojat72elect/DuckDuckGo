...
interface SyncNotificationBuilder {
    fun buildSyncPausedNotification(
        context: Context,
        addNavigationIntent: Boolean = true
    ): Notification
    ...
    override fun buildSyncPausedNotification(
        ...
        val notificationBuilder = NotificationCompat.Builder(context, SYNC_NOTIFICATION_CHANNEL_ID)
            ...
            .setCustomContentView(
                RemoteViews(
                    context.packageName,
                    R.layout.notification_sync_paused
                )
            )
    ...
    override fun buildSyncErrorNotification(
        ...
        val notificationBuilder = NotificationCompat.Builder(context, SYNC_NOTIFICATION_CHANNEL_ID)
            ...
            .setCustomContentView(
                RemoteViews(
                    context.packageName,
                    R.layout.notification_sync_error
                )
            )
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setCategory(NotificationCompat.CATEGORY_STATUS)
    ...
    override fun buildSyncSignedOutNotification(
        ...
        val notificationBuilder = NotificationCompat.Builder(context, SYNC_NOTIFICATION_CHANNEL_ID)
            ...
            .setCustomContentView(
                RemoteViews(
                    context.packageName,
                    R.layout.notification_sync_signed_out
                )
            )
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setCategory(NotificationCompat.CATEGORY_STATUS)
