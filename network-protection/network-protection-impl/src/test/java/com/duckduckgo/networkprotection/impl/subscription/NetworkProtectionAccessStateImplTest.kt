...
class NetworkProtectionAccessStateImplTest {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnInactiveAndNetpEnabledThenReturnNotUnlockedAndResetVpnState() =
        runTest {
            whenever(netpSubscriptionManager.getVpnStatus()).thenReturn(INACTIVE)
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnExpiredAndNetpEnabledThenReturnNotUnlockedAndResetVpnState() =
        runTest {
            whenever(netpSubscriptionManager.getVpnStatus()).thenReturn(EXPIRED)
            whenever(networkProtectionState.isEnabled()).thenReturn(true)
            testee.getState().also {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnSignedOutAndNetpEnabledThenReturnNotUnlockedAndResetVpnState() =
        runTest {
            whenever(netpSubscriptionManager.getVpnStatus()).thenReturn(SIGNED_OUT)
            whenever(networkProtectionState.isEnabled()).thenReturn(true)
            testee.getState().also {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnInactiveAndNetpDisabledThenReturnFlowEmitsNotUnlocked() =
        runTest {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnExpiredAndNetpDisabledThenReturnFlowEmitsNotUnlocked() =
        runTest {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnSingedOutAndNetpDisabledThenReturnFlowEmitsNotUnlocked() =
        runTest {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnInactiveAndNetpEnabledThenReturnFlowEmitNotUnlockedAndResetVpnState() =
        runTest {
            whenever(netpSubscriptionManager.vpnStatus()).thenReturn(flowOf(INACTIVE))
            whenever(networkProtectionState.isEnabled()).thenReturn(true)
            testee.getStateFlow().test {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnExpiredAndNetpEnabledThenReturnFlowEmitNotUnlockedAndResetVpnState() =
        runTest {
            whenever(netpSubscriptionManager.vpnStatus()).thenReturn(flowOf(EXPIRED))
            whenever(networkProtectionState.isEnabled()).thenReturn(true)
            testee.getStateFlow().test {
    ...
    @Test
    fun whenSubscriptionsEnabledAndVpnSignedOutAndNetpEnabledThenReturnFlowEmitNotUnlockedAndResetVpnState() =
        runTest {
            whenever(netpSubscriptionManager.vpnStatus()).thenReturn(flowOf(SIGNED_OUT))
            whenever(networkProtectionState.isEnabled()).thenReturn(true)
            testee.getStateFlow().test {
