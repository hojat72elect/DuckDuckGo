...
class SubscriptionFeedbackGeneralFragment :
    SubscriptionFeedbackFragment(R.layout.content_feedback_general) {
    ...
    companion object {
        internal fun instance(): SubscriptionFeedbackGeneralFragment =
            SubscriptionFeedbackGeneralFragment()
    }
}
