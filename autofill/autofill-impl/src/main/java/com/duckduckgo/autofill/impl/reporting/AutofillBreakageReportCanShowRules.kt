...
class AutofillBreakageReportCanShowRulesImpl @Inject constructor(
    ...
    override suspend fun canShowForSite(url: String): Boolean {
        return withContext(dispatchers.io()) {
            ...
            val eTldPlusOne =
                urlMatcher.extractUrlPartsForAutofill(url).eTldPlus1 ?: return@withContext false
    ...
    private suspend fun String.siteReportSentRecently(): Boolean {
        ...
        val minDaysBeforeResubmissionAllowed =
            dataStore.getMinimumNumberOfDaysBeforeReportPromptReshown()
