...
class AppNewTabSettingsStore @Inject constructor(private val context: Context) :
    NewTabSettingsStore {
    ...
    override var sectionSettings: List<String>
        ...
        set(value) = preferences.edit(true) {
            putString(
                KEY_NEW_TAB_SECTION_SETTINGS_ORDER,
                fromStringList(value)
            )
        }
    ...
    override var shortcutSettings: List<String>
        ...
        set(value) = preferences.edit(true) {
            putString(
                KEY_NEW_TAB_SHORTCUT_SETTINGS_ORDER,
                fromStringList(value)
            )
        }
    ...
    companion object {
        ...
        private const val KEY_NEW_TAB_SHORTCUT_SETTINGS_ORDER =
            "KEY_NEW_TAB_SHORTCUT_SETTINGS_ORDER"
    }
}
